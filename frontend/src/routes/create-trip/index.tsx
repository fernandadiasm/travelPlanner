          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex item gap-2">
            ...
            <form onSubmit={addNewEmailToInvite}
              ...
              <button type="submit" className="bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gapt-2 hover:bg-lime-400">
                Convidar
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                Para concluir a criação da viagem para <strong className="fonti-semibold text-zinc-100">Florianópolis, Brasil</strong> nas datas de <strong className="fonti-semibold text-zinc-100">16 a 27 de Agosto de 2024</strong> preencha seus dados abaixo:
              </p>
            </div>
            ...
            <form onSubmit={addNewEmailToInvite} className="space-y-3">
              ...
              <button onClick={openConfirmTripModal} type="submit" className="bg-lime-300 text-lime-950 rounded-lg px-5 h-11 font-medium flex items-center gapt-2 hover:bg-lime-400 w-full justify-center">
